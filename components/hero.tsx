  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Amber orb - bottom left (subtle warmth) */}
        ...
        {/* Soft ambient lines - teal tones */}
        <div className="absolute top-1/4 left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-teal/20 to-transparent" />
        <div className="absolute top-1/3 left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-teal-dark/10 to-transparent" />
        <div className="absolute top-2/3 left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-teal/10 to-transparent" />
      </div>
            ...
            <div className="gradient-border rounded-xl p-[1px]">
              <div className="rounded-xl bg-card/80 backdrop-blur-sm p-5">
                ...
                <div className="relative group">
                  <code className="block rounded-lg bg-background/80 px-4 py-3 pr-12 font-mono text-sm text-foreground">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-md bg-secondary/50 border border-border/50 text-muted-foreground hover:text-foreground hover:bg-secondary transition-all opacity-0 group-hover:opacity-100"
